...
# Map the generate_reports function to the '/reports' URL
routes_in = (
    ('/reports', '/WebProject/report/generate_reports'),
)


routes_in = (
    ('/admin/create_admin_account', '/WebProject/default/create_admin_account'),
)
